...
| **Mature M.19–M.26** | Planned — dual voice (`noir`/`lewd`), SFW `persona`, `scene`/`whisper`, client Rich mature format; see PHASES **M.19–M.26** and [`docs/MATURE_CONTENT.md`](docs/MATURE_CONTENT.md) |
