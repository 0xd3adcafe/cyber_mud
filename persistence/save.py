...
def player_to_dict(player: Player) -> dict:
    ...
    return {
        ...
        "net_trace": player.net_trace,
        "net_connected_node": player.net_connected_node,
        "net_route_node": player.net_route_node,
        "net_breached_nodes": list(player.net_breached_nodes),
...
def player_from_dict(data: dict) -> Player:
    ...
    player = Player(
        ...
        net_trace=int(data.get("net_trace", 0)),
        net_connected_node=str(data.get("net_connected_node", "")),
        net_route_node=str(data.get("net_route_node", "")),
        net_breached_nodes=list(data.get("net_breached_nodes", [])),
