...
| **世界擴充（WORLD.md）** | W.1–W.14 — 程序格點、八區地圖、主線錨點（`crypt`、`data_vault`、guard/priest/rat）、`help tutorial`、派系深度、天氣／作息、黑市、多人存在感、NETRUN 主線節點、中毒／過熱、動態世界回饋；見 PHASES **世界擴充** |
| **生活指令** | L.1–L.8 — `sit`／`stand`／`rest`／`sleep`／`wake`；姿態＋疲勞；房間／天氣／互動物修正；vitals＋trauma 整合；見 PHASES **生活指令** |
